...
var Rogue = /** @class */ (function (_super) {
    ...
    Rogue.prototype.oocAbility = function (player) {
        player.$$game.eventManager.doEventFor(player, Event_1.EventName.BlessGold);
        player.$$game.eventManager.doEventFor(player, Event_1.EventName.Gamble);
        player.$$game.eventManager.doEventFor(player, Event_1.EventName.Merchant);

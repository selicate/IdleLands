...
var BlessGold = /** @class */ (function (_super) {
    ...
    BlessGold.prototype.operateOn = function (player) {
        if (player.$party && this.rng.likelihood(25)) {
            player.$$game.eventManager.doEventFor(player, Event_1.EventName.BlessGoldParty);
            return;
        }
        ...
        var eventText = this.eventText(Event_1.EventMessageType.BlessGold, player, { gold: totalGoldGain });

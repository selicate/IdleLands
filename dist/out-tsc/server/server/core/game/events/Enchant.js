...
var Enchant = /** @class */ (function (_super) {
    ...
    Enchant.prototype.operateOn = function (player) {
        ...
        var choice = this.rng.chance.weighted([Event_1.EventMessageType.Tinker, Event_1.EventMessageType.Enchant], [0.15, 0.85]);
        var eventText = this.eventText(choice, player, { item: item.fullName() });
        var stat = this.pickStat();
        var boost = 25;
        if (choice === Event_1.EventMessageType.Tinker) {

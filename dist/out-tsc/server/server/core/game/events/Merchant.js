...
var Merchant = /** @class */ (function (_super) {
        ...
        switch (valueChosen) {
            case 'Yes': {
                ...
                if (isEnchant) {
                    ...
                    eventManager.doEventFor(player, Event_1.EventName.Enchant);
    ...
    Merchant.prototype.operateOn = function (player) {
        ...
        var eventText = this.eventText(Event_1.EventMessageType.Merchant, player, { item: item.fullName(), shopGold: cost });

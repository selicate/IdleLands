...
var BlessXP = /** @class */ (function (_super) {
    ...
    BlessXP.prototype.operateOn = function (player) {
        if (player.$party && this.rng.likelihood(25)) {
            player.$$game.eventManager.doEventFor(player, Event_1.EventName.BlessXPParty);
            return;
        }
        ...
        var eventText = this.eventText(Event_1.EventMessageType.BlessXP, player, { xp: totalXPGain });

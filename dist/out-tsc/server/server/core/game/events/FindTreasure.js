...
var FindTreasure = /** @class */ (function (_super) {
    ...
    FindTreasure.prototype.operateOn = function (player, opts) {
        ...
        if (Date.now() < curTimer) {
            ...
            this.emitMessage([player], "You could not loot " + opts.treasureName + " because it was empty! Check back at %timestamp.", interfaces_1.AdventureLogEventType.Explore, { timestamp: curTimer });
            return;
        }
        // 30 minute cooldown
        ...
        player.$$game.eventManager.doEventFor(player, Event_1.EventName.FindItem, { fromChest: true, item: specificItem });
    };

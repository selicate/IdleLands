...
var Event_1 = require("../../../server/core/game/events/Event");
            ...
            switch (main) {
                ...
                case 'item': {
                    ...
                    if (sub === 'generated') {
                        ...
                        player.$$game.eventManager.doEventFor(player, Event_1.EventName.FindItem, { fromPet: true, item: generatedItem });
                    }
                    if (sub === 'guardian') {
                        var item = items[choice];
                        var generatedItem = player.$$game.itemGenerator.generateGuardianItem(player, choice, item.type, item);
                        player.$$game.eventManager.doEventFor(player, Event_1.EventName.FindItem, { fromGuardian: true, item: generatedItem });
                    }
                    if (sub === 'buffscroll') {
                        var stats_1 = {};

...
var Player = /** @class */ (function () {
    ...
    Player.prototype.recalculateStats = function () {
        ...
        allStats.forEach(function (stat) {
            ...
            _this.addStatTrail(stat, profBasePerLevel, _this.profession + ": Base / Lv. (" + profBasePerLevel / _this.level.total + ")");
            // item adds
    ...
    Player.prototype.tryToDoNewCharacter = function () {
        var canDo = this.$choices.$choicesData.choices.length === 0 && this.$statistics.get('Character/Choose/Total') === 0;
        if (!canDo)
            return;

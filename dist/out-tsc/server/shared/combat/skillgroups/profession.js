    ...
    _c[interfaces_1.Profession.Archer] = [
        ...
        { weight: 2,
            ...
            skills: [
                ...
                skillcomponents_1.Description('%source unleased a relentless assault on %target and dealt %value damage!'),
    ...
    _c[interfaces_1.Profession.Jester] = [
        ...
        { weight: 2, skills: [
                [
                    ...
                    skillcomponents_1.StatMod(interfaces_1.Stat.LUK, skillcomponents_1.RandomNumber(function (caster) { return -caster.stats[interfaces_1.Stat.LUK]; }, function (caster) { return caster.stats[interfaces_1.Stat.LUK]; }, true)),
        ...
        { weight: 2, skills: [
                [
                    ...
                    skillcomponents_1.StatMod(interfaces_1.Stat.LUK, skillcomponents_1.RandomNumber(function (caster) { return caster.stats[interfaces_1.Stat.LUK] * 3; }, function (caster) { return caster.stats[interfaces_1.Stat.LUK] * 5; })),
